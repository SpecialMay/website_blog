...
<div >
    ...
    <div style="background: backgroundcolor:;margin:30%" class="team-cont text-center w3pvt-info_mail_grid_right">

        <div style="height:30%">  </div>
        <div style ="color:snow;margin: 5% 0% 0% 0%;width:100%;height:60% " >
            <h3 class="title  text-wh font-weight-bold">Login</h3>
            <div style="">
                <form action = "login_check.php" method="post" class = "form-horizontal" role = "form">
                    ...
                    <div class = "form-group">
                        ...
                        <div class = "text-wh font-weight-bold">
                            Don't have an Account? <a style="color:white" href = register.php><u><b>Register</b></u></a> now!
                        </div>
                    </div>
                </form>
            </div>
